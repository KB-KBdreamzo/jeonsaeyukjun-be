...
public class CrawlingService {
    ...
    private static final Map<String, String> BUILDING_TYPE_MAP = Map.of(
        ...
        public CrawlingService() {
            // 드라이버 맞게 고쳐야함
            System.setProperty("webdriver.chrome.driver", "/Users/jangbongjun/Desktop/KbDreamZo/jeonsaeyukjun-be/src/main/resources/chromedriver-mac-arm64/chromedriver");
